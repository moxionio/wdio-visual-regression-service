...
var LocalCompare = function (_BaseCompare) {
  ...
  function LocalCompare() {
    ...
    _this.compareOptions = options.compare;
    return _this;
  }
  ...
  (0, _createClass3.default)(LocalCompare, [{
    ...
    value: function afterScreenshot(context, base64Screenshot) {
      var screenshotPath, referencePath, referenceExists, captured, compareData, isSameDimensions, misMatchPercentage, misMatchTolerance, diffPath, png;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              ...
              _context.next = 12;
              return _regenerator2.default.awrap(this.compareImages(referencePath, captured));
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _regenerator2.default.awrap(new _promise2.default(function (resolve) {
                ...
                if (_this2.compareOptions) {
                  image.ignore(_this2.compareOptions);
                }
